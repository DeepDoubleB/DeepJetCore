...
model = conv_model_final([Input(shape=(1,27)),Input(shape=(60,8)),Input(shape=(5,2))], 2, 0, ['db','cpf','sv'])
model.load_weights(args.inputModel)
...
#pred_node_names = ['softmax/Softmax']
